            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>Mumbai</h3>
                            <p className='text-sm -mt-1 text-gray-600'>India</p>
                        </div>
                    </div>
                ...
                <button onClick={()=>{ props.setConfirmRidePopupPanel(true) }} className=' bg-green-600 w-full text-white font-semibold p-2 px-10 rounded-lg'>Accept</button>
